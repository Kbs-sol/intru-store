...
INSERT OR IGNORE INTO products (id, name, slug, description, price, original_price, image_url, image_url_2, category, is_featured, is_active, stock) VALUES 
  ...
  (3, 'Orange Puff Printed T-Shirt', 'orange-puff-tshirt', 'Statement piece with 3D puff printing. Vibrant orange accents on premium fabric. Stand out from the crowd.', 899.00, 1499.00, 'https://cdn.shopify.com/s/files/1/0622/3628/2180/files/DSC05910_3.jpg?v=1730301968', 'https://cdn.shopify.com/s/files/1/0622/3628/2180/files/DSC05909.jpg?v=1730301968', 'T-Shirts', 1, 1, 50),
